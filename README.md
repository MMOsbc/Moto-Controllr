...
________________________________________
**6. Demonstração**
O vídeo abaixo apresenta as principais funcionalidades do aplicativo MotoControllr, incluindo cadastro de motos, abastecimentos, manutenções, checklist de segurança e dashboard.
[![Demonstração do MotoControllr](https://img.youtube.com/vi/ID_DO_VIDEO/0.jpg)](https://www.youtube.com/watch?v=VTK332vzbO0)
________________________________________ 
**7. Pré-requisitos**
•	Node.js v24.15.0
•	Expo CLI 
•	Conta no Firebase 
•	Expo Go e um celular Android ou emulador Android (SDK 52)
________________________________________
...
**9. Aprendizados e Futuros upgrades**
...
Como melhorias futuras, pretende-se integrar funcionalidades de mapas dentro do aplicativo, permitindo ao usuário localizar estabelecimentos voltados ao universo motociclístico, como oficinas especializadas, lojas de peças, postos de combustível e motoclubes próximos.
Outra funcionalidade planejada é a implementação de uma API para envio de e-mails, possibilitando recursos como recuperação de senha por meio de código de verificação, aumentando a segurança e a praticidade no acesso à conta.
Também está prevista a criação de uma tela de entrada com transições visuais e divulgação de serviços relacionados a motocicletas. Essa funcionalidade poderá ser utilizada futuramente como forma de monetização da aplicação, através de parcerias e anúncios voltados ao público motociclista.
